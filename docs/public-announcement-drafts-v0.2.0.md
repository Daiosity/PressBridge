# Public Announcement Drafts v0.2.0
...
If you work with WordPress + React, I’d love feedback on:
- route edge cases
- preview flow
- Gutenberg layouts that break structurally
- onboarding/install friction
...
- route resolution
- common Gutenberg layouts
- preview foundations
- package/install confidence

No theme parity or “everything is solved” claims.
...
It does not claim WooCommerce, ACF, Elementor, theme parity, or universal block compatibility as solved.

If you work with WordPress + React and want to try a practical bridge approach, I’d really value feedback on routing, preview behavior, Gutenberg layout stability, and onboarding friction.
